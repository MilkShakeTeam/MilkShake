...
# Exemple d'usage : recherche d'une chanson
# print PyNchLine.get_lyrics_by_search_terms("maitre gims bella")

# Exemple d'usage : recherche d'une chanson au hasard d'un artiste (avec récupération du nom de la chanson)
# print PyNchLine.get_random_song_by_artist("mc solaar", with_song_name=True)

# Exemple d'usage : recherche sur Rockgenius (avec instanciation de la classe)
# pynchline = PyNchLine("http://rock.rapgenius.com/")
# print pynchline.get_random_song_by_artist("in flames")

# Exemple d'usage : Récupération de quelques punchlines au hasard par artiste
for i in range(1, 6):
    print PyNchLine.get_random_punchline_by_artist("kaaris", with_song_name=True)